...
public class IfElseWithLoops {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println(myInt [2]); for (int i=0; i<myInt.length; i++) {
		 ...
		 */
		/*
		 * for( int j :myInt2) { System.out.println(j); }
		 */
		...
		for(String s :names)
		{
			...
			{
				System.out.println("We couldn't find any name");
